...
type InflowRow = Funnel & { inflow: string }
type MarketingData = {
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5">
                <h2 className="text-sm font-semibold text-gray-700 mb-4">流入元別 歩留まり</h2>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        ...
                        <th className="text-right px-3 py-2 text-xs font-medium text-gray-500">面接設定</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {data.byInflow.map(row => (
                        <tr key={row.inflow} className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-right text-indigo-600">{row.interviewSet}</td>
                    ...
                    <tfoot className="bg-gray-50 border-t border-gray-200">
                      <tr>
                        ...
                        <td className="px-3 py-2 text-right text-gray-500">{rate(o?.contact ?? 0, o?.apply ?? 0)}</td>
                        <td className="px-3 py-2 text-right font-bold text-indigo-700">{o?.interviewSet ?? 0}</td>
